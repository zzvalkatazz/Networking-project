     ...
     new Thread(() ->{
         try{
             ...
             if(upper.startsWith("IMPORT")){
              ...
              out.println("IMPORT");
              try(BufferedReader fr = new BufferedReader(new InputStreamReader(new java.io.FileInputStream(fileName), "UTF-8"))){
                String fileLine;
                while((fileLine = fr.readLine()) !=null){
                    out.println(fileLine);
                }
              }catch(Exception ex){
                  logArea.append("Грешка при четене на файл: " + ex.getMessage() + "\n");
                  out.println("END");
             ...
             out.println("EXPORT");
             try (java.io.BufferedWriter bw = new java.io.BufferedWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream("coins.csv"), "UTF-8"))){
                 String line;
                 ...
                 logArea.append("--- Успешно записано в coins.csv ---\n");
             }
         }
             else{
             out.println(cmd);
